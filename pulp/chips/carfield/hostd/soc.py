...
class Soc(st.Component):
    ...
    def __init__(self, parent, name, parser, chip, pulp_cluster=None):
        ...
        l2 = memory.Memory(self, 'l2', size=0x100000, atomics=True, width_log2=-1)
        ...
        #self.bind(self, 'pulpd_dma_irq', plic, 'irq2') # TODO: test
        ...
        # Pulp cluster connection
        if pulp_cluster:
            pulpd_base = pulp_cluster.get_property('mapping/base')
            ...
            # Pulpd -> Host
            self.bind(self, 'soc_input', narrow_axi, 'input')
